...
public class Rectangle implements IShape,Serializable {
    ...
    public Rectangle(Point mousePressed, Point mouseReleased, ShapeColor primaryColor, ShapeColor secondaryColor, ShapeShadingType shapeShadingType) {
...
//        System.out.println(primaryColorAdaptor.getColor(primaryColor));
        ...
        if (shapeShadingType.equals(ShapeShadingType.OUTLINE)) {
            ...
            g.drawRect(x[0], y[0], width, height);
    ...
    public Boolean contain(Point startpoint) {
       return ( x[0] < startpoint.getX() && y[0] < startpoint.getY() && x[0] + width > startpoint.getX() && y[0] + height > startpoint.getY());
    }
