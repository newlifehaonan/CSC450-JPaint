...
public class EllipseStrategy implements IStrategy {
	...
	public EllipseStrategy(ShapeShadingType shadetype,ColorAdapter primarycolor,ColorAdapter secondarycolor,Point point) {
